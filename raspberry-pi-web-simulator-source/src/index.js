...
class Index extends Component {
  ...
  render() {
    ...
    return (
      <div className="main">
        <Banner reloadMain={this.forceUpdate.bind(this)} toggleHelpState={this.toggleHelpState} />
        ...
        <HelpOverlay needShowHelp={showHelp} toggleHelpState={this.toggleHelpState} />
      </div>
    );
  }
}
